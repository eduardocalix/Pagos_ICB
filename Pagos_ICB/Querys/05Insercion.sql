...
EXEC SP_AgregarAlumno '','Leana Camila',' Acosta Argueta',1,'No' 
EXEC SP_AgregarAlumno '','Zoe Yadira',' Rivera Oviedo',1,'No'
EXEC SP_AgregarAlumno '','Cristian Manuel',' Machado Ramirez',2,'No'
EXEC SP_AgregarAlumno '','Emilia Monserrath ','Rivera Dubon',2,'No'
EXEC SP_AgregarAlumno '','Milton Rodrigo ','Arias Amaya',2,'No'
EXEC SP_AgregarAlumno '','Nathalie Jimena ','Lazo Barralaga',2,'No'
EXEC SP_AgregarAlumno '','Adriana Argelia',' Miranda',3,'No'
EXEC SP_AgregarAlumno '','Allyson Samantha ','Mejia Mejia',3,'No'
EXEC SP_AgregarAlumno '','Clara ','Benitez Puerto',3,'Si'
EXEC SP_AgregarAlumno '','Emiliano Rodrigo',' Davila Izaguirre',3,'No'
EXEC SP_AgregarAlumno '','Juan Fernando ','Suazo Escobar',3,'No'
EXEC SP_AgregarAlumno '','wilder Danery',' Flores Velasquez',3,'No'
EXEC SP_AgregarAlumno '','Anthony Jafeth ','Chavarria Duarte',4,'No'
EXEC SP_AgregarAlumno '','Diego José ','Ruiz Andino',4,'No'
EXEC SP_AgregarAlumno '','Francisco André',' Lazo Barralaga',4,'No'
EXEC SP_AgregarAlumno '','Kelvin Francisco',' Argueta Castillo',4,'No'
 EXEC SP_AgregarAlumno '','Alejandro Mateo ','Cerro',5,'No'
EXEC SP_AgregarAlumno '','Diego Alejandro ','Alvarez',5,'No'
EXEC SP_AgregarAlumno '','Emily Dayana ','Orellana Recarte',5,'No'
EXEC SP_AgregarAlumno '','Henry Isac ','Bonilla',5,'No'
EXEC SP_AgregarAlumno '','Jose Sebastian',' Meza Delcid',5,'No'
EXEC SP_AgregarAlumno '','Marjurie Ivannia ','Almendares Lizardo',5,'No'
EXEC SP_AgregarAlumno '','Alfonso Felipe Miguel ','Matute Barahona',6,'No'
EXEC SP_AgregarAlumno '','Jose Federico ','Benitez Puerto',6,'Si'
EXEC SP_AgregarAlumno '','Rebeca Isabel ','Morales Vega',6,'No'
EXEC SP_AgregarAlumno '','Sofia Alejandra ','Cruz Andino',6,'No'
EXEC SP_AgregarAlumno '','Alicia Mercedes ','Ortíz Rubio',7,'No'
EXEC SP_AgregarAlumno '','Ballardo Antonio ','Morales Vega',7,'No'
EXEC SP_AgregarAlumno '','Danna Paola ','Alvarez',7,'No'
EXEC SP_AgregarAlumno '','Lorielly Lineth',' Avila lagos',7,'No' 
EXEC SP_AgregarAlumno '','Mia Yuliana ','Chavarria Recarte',7,'No'
EXEC SP_AgregarAlumno '','Oscar Alejandro',' Vasquez Lopez',7,'No'
EXEC SP_AgregarAlumno '','Sady Andres ','Rivera Jaco',7,'No'
EXEC SP_AgregarAlumno '','Adriana María ','Ortíz Rubio',8,'No'
EXEC SP_AgregarAlumno '','Ana Giselle ','Chevez Cruz',8,'No'
EXEC SP_AgregarAlumno '','Carmen Daniela',' Lopez Perez',8,'No'
EXEC SP_AgregarAlumno '','Isabella Maria ','Linares Salgado',8,'No'
EXEC SP_AgregarAlumno '','Manuel Ernesto ','Rios Lagos',8,'No'
EXEC SP_AgregarAlumno '','Marianne Elizabeth',' Romero Pineda',8,'No'
EXEC SP_AgregarAlumno '','Mario Ricardo ','Umanzor Bonilla',8,'No'
EXEC SP_AgregarAlumno '','Milagro Alejandra',' Alvarado Diaz',8,'No'
EXEC SP_AgregarAlumno '','Angela Samantha ','Portillo Rivera',9,'No'
EXEC SP_AgregarAlumno '','Astrid Gabriela ','Bonilla Sierra',9,'No'
EXEC SP_AgregarAlumno '','Sarah Francel ','Lazo Barralaga',9,'No'
EXEC SP_AgregarAlumno '','Fabricio Josimar ','Palma Castillo',9,'No'
EXEC SP_AgregarAlumno '','Gracia Maria ','Machado Ramirez',9,'No'
EXEC SP_AgregarAlumno '','Maria Regina ','Benitez Puerto',9,'No'
EXEC SP_AgregarAlumno '','Nelson Jose Chevez Cruz',9,'No'
EXEC SP_AgregarAlumno '','Reniery David ','Almendarez Ramos',9,'No'
EXEC SP_AgregarAlumno '','Aldrin Leonel Santos',10,'No'
EXEC SP_AgregarAlumno '','Emy Dayana ','Hernández Fuentes',10,'No'
EXEC SP_AgregarAlumno '','Fernando Antonio',' Salinas Romero',10,'No'
EXEC SP_AgregarAlumno '','Jorge Alberto',' Lazo Barralaga ',10,'No'
EXEC SP_AgregarAlumno '','Miguel Edgardo',' Martinez Sarmientos',10,'No'
EXEC SP_AgregarAlumno '','Nazareth',' Maradiaga Irias',10,'No'
EXEC SP_AgregarAlumno '','Franklin Josiel',' Sanchez Bonilla',10,'No'
EXEC SP_AgregarAlumno '','Allie Suset ','Hernández Fuentes',11,'No'
EXEC SP_AgregarAlumno '','Andy Manuel ','Alvarado Bonilla',11,'No'
EXEC SP_AgregarAlumno '','Emily Nicolle ','Banegas Saravia ',11,'No'
EXEC SP_AgregarAlumno '','Montserrath ','Maradiaga Irias',11,'No'
EXEC SP_AgregarAlumno '','Alejandro Javier ','Cervantes Cruz',12,'No'
EXEC SP_AgregarAlumno '','David Andres ','Quezada Flores',12,'No'
EXEC SP_AgregarAlumno '','Diego Enrique Velasquez Umanzor',12,'No'
EXEC SP_AgregarAlumno '','Emilio Jose ','Rivera Alvarado',12,'No'
EXEC SP_AgregarAlumno '','Juan Diego ','Martinez Mejia',12,'No'
EXEC SP_AgregarAlumno '','Sebastian Andres',' Molina Letelier',12,'No'
EXEC SP_AgregarAlumno '','Angely Alejandra ','Torres Matute',13,'No'
EXEC SP_AgregarAlumno '','Claudio Alejandro ','Montoya Caceres',13,'No'
EXEC SP_AgregarAlumno '','Daniel Ernesto','Alvarado Cruz',13,'No'
EXEC SP_AgregarAlumno '','Denis Sady ','Santos',13,'No'
EXEC SP_AgregarAlumno '','Flavio Javier ','Rios Lagos',13,'No'
EXEC SP_AgregarAlumno '','Freddy Alberto ','Portillo Rivera',13,'No'
EXEC SP_AgregarAlumno '','Lastenia Isabel ','Andara Argueta',13,'No'
EXEC SP_AgregarAlumno '','Liliana Isabel ','Meza Delcid',13,'No'
EXEC SP_AgregarAlumno '','Marjorie Nicole ','Acosta Cooper',13,'No'
EXEC SP_AgregarAlumno '','Wilger Eduardo ','Flores Velasquez',13,'No'
EXEC SP_AgregarAlumno '','Ana Jose ','Santamaria Orellana',14,'No'
EXEC SP_AgregarAlumno '','Andrea Gisselle Rodriguez David',14,'No'
EXEC SP_AgregarAlumno '','Angie Johanna ','Irias Doblado',14,'No'
EXEC SP_AgregarAlumno '','Anielska Marcela',' Villeda Aguilar',14,'No'
EXEC SP_AgregarAlumno '','Aldrina ','Santos Lagos',14,'No'
EXEC SP_AgregarAlumno '','Alejandro Jose',' Chan',14,'No'
EXEC SP_AgregarAlumno '','Claudia Elena ','Portillo Rivera',14,'No'
EXEC SP_AgregarAlumno '','Daniella Maria ','Salinas Romero',14,'No'
EXEC SP_AgregarAlumno '','Diana Isabel ','Banegas Morales',14,'No'
EXEC SP_AgregarAlumno '','Erika Marcela ','Lazo Barralaga',14,'No'
EXEC SP_AgregarAlumno '','Juan Carlos ','Zapata Ponce',14,'No'
EXEC SP_AgregarAlumno '','Marisabel ','Martinez Mejia',14,'No'
EXEC SP_AgregarAlumno '','Meylin Nicole ','Morales Alvarado',14,'No'
EXEC SP_AgregarAlumno '','Paola Nicolle',' Merino Adriano',14,'No'
